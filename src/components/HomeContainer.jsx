  ...
  return (
    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full" id="home">
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        <div
          className="flex items-center gap-2 justify-center bg-orange-100 px-4
      py-1 rounded-full"
        >
        ...
        <p className="text-base text-textColor text-center md:text-left md:w-[80%]">
          ...
          similique tempora qui odit voluptatem fuga neque, nulla necessitatibus
          dicta molestias hic inventore alias. Temporibus laboriosam laudantium
          error sint eius.
        </p>
      ...
      <div className="py-2 flex-1 flex items-center relative">
          <img src={HeroBg} 
          className='ml-auto h-420 w-full lg:w-auto lg:h-600' alt="hero-bg"/>
